...
SECRET_KEY = 'django-insecure-c=u+-p&i@e-pfx*xb7@z3qutu+(ybxt-^y#-)8)u9z@(ecazi_'
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # Email send

# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/4.0/howto/static-files/

STATIC_URL = 'social_site/static/'
STATICFILES_DIRS = [
